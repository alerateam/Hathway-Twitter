...
import com.wearehathway.artemk.hathwaytwitter.dummy.DummyContent;
...
public class TwitterItemListActivity extends AppCompatActivity {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final View.OnClickListener mOnClickListener = new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mTwoPane) {
                    ...
                    arguments.putString(TwitterItemDetailFragment.ARG_ITEM_ID, item.id);
                    ...
                    Intent intent = new Intent(context, TwitterItemDetailActivity.class);
                    intent.putExtra(TwitterItemDetailFragment.ARG_ITEM_ID, item.id);
        ...
        SimpleItemRecyclerViewAdapter(TwitterItemListActivity parent,
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.twitteritem_list_content, parent, false);
